...
\begin{figure}[H]
    \centering
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/all/1.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/all/2.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/all/3.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/all/4.png}
    \label{fig:map2}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/all/5.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/all/6.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/all/7.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/all/8.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.48\textwidth]{Images/Exercise 7/move/1.png}
    \includegraphics[width=.48\textwidth]{Images/Exercise 7/move/2.png}
    \includegraphics[width=.48\textwidth]{Images/Exercise 7/move/3.png}
    \includegraphics[width=.48\textwidth]{Images/Exercise 7/move/4.png}
    \label{fig:map4}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/move/5.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/move/6.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/move/7.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/move/8.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/rep/1.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/rep/2.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/rep/3.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/rep/4.png}
    \label{fig:map6}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/rep/5.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/rep/6.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/rep/7.png}
    \includegraphics[width=.49\textwidth]{Images/Exercise 7/rep/8.png}
